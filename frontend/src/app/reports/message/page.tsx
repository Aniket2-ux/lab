...
const MessageReportPage: React.FC = () => {
  return (
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-8">
          ...
          <section className="mb-6 rounded-md bg-gray-100 p-4 md:p-6">
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="flex flex-col text-sm">
                <span className="mb-1 text-gray-600">SMS Status</span>
              ...
              <table className="min-w-full text-left text-sm">
                <thead className="border-b bg-gray-50 text-xs font-semibold uppercase tracking-wide text-gray-500">
                  <tr>
                    ...
                    <th className="px-4 py-3">Reason of Failure</th>
                    <th className="px-4 py-3">Message Type</th>
                    <th className="px-4 py-3">SMS Content</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
