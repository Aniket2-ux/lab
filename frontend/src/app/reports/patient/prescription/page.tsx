...
const PatientPrescriptionReportPage: React.FC = () => {
  return (
              ...
              <table className="min-w-full text-left text-sm">
                <thead className="border-b bg-gray-50 text-xs font-semibold uppercase tracking-wide text-gray-500">
                  <tr>
                    ...
                    <th className="px-4 py-3">Attachment Count</th>
                    <th className="px-4 py-3">OPD Duration</th>
                    <th className="px-4 py-3">Diagnosis</th>
                    <th className="px-4 py-3">Medication</th>
                    <th className="px-4 py-3">Medication Remarks</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
...
export default PatientPrescriptionReportPage;
