...
const StockCashFlowReportPage: React.FC = () => {
  return (
              ...
              <table className="min-w-full text-left text-sm">
                <thead className="border-b bg-gray-50 text-xs font-semibold uppercase tracking-wide text-gray-500">
                  <tr>
                    ...
                    <th className="px-4 py-3">Net Sales Amount</th>
                    <th className="px-4 py-3">Cost of Sales</th>
...
export default StockCashFlowReportPage;
